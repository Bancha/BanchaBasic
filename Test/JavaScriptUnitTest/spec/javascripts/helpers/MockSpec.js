...
describe('Mock tests', function() {
    ...
    it('should be able to test function arguments', function() {
        ...
        expect(function() {
            ...
            'mock function "fnWithArguments"\'s call 0. ',
            'Argument[2].b[0]: Expected "array string with wrong content"(string) ',
            'to be equal to "array content string"(string)'
        ].join(''));
    });
    ...
    it("should be able to recognize value types from Mock.Value", function() {
        ...
        expect(function() {
            ...
            'mock function "fnWithSpecialArguments"\'s call 0. ',
            'Argument[0]: Expected [object Object](object) to be a function.'
        ].join(''));
